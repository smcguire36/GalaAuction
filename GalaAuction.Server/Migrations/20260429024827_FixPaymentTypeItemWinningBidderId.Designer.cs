...
namespace GalaAuction.Server.Migrations
{
    ...
    [Migration("20260429024827_FixPaymentTypeItemWinningBidderId")]
    partial class FixPaymentTypeItemWinningBidderId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GalaAuction.Server.Models.Guest", b =>
                {
                    ...
                    b.Property<Guid?>("CheckoutLock")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("CheckoutLockedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GalaAuction.Server.Models.Item", b =>
                {
                    ...
                    b.HasOne("GalaAuction.Server.Models.Bidder", "WinningBidder")
                        .WithMany("ItemsWon")
